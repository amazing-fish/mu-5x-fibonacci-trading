...
- OKX [rebased and renamed SPACEX perpetual to SPCX](https://www.okx.com/zh-hans/help/okx-to-execute-rebase-on-spacexusdt-pre-market-perpetual-futures-and-rename) at 2026-06-02 07:10 UTC, changing its price and contract-unit basis by 12.52. Trusted refresh retains only complete SPCX candles on the new basis: from 07:10 for 5m, 07:15 for 15m, and 08:00 for 1h. It does this before physical and built/native validation, and records the boundary and source in dataset warnings. Pre-rebase bars and parent bars crossing the event are not published or back-adjusted; a 180-day request therefore reports shorter `partial_available_history` until 180 post-rebase days exist. The ordinary 2% continuity and all other trust checks still apply to the retained data.
